...
weight_path = os.path.join(
    ROOT_DIR, 'weights/vgg19_weights_tf_dim_ordering_tf_kernels_notop.h5')
print(weight_path)
...
model = applications.VGG19(
    weights=weight_path, include_top=False, input_shape=(img_width, img_height, 3))
print(model.output)
...
x = Dropout(0.5)(x)
x = Dense(1024, activation='relu')(x)
pretiction = Dense(2, activation='softmax')(x)
